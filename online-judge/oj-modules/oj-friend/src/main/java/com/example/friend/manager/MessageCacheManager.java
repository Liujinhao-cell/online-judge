...
public class MessageCacheManager {
    ...
    public List<MessageTextVO> getMessageTextVOList(PageQueryDTO dto,Long userId) {
        ...
        List<MessageTextVO> messageTextVOList = assembleMessageTextVOList(msgTextIdList);
        if (CollectionUtil.isEmpty(messageTextVOList)) {
    ...
    private List<MessageTextVO> assembleMessageTextVOList(List<Long> msgTextIdList) {
